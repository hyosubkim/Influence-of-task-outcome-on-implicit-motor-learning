...
bestparams_popnVectorMR = temp_bestparams(bestidx,:);
r2_popnVectorMR = temp_r2(bestidx);
aic_popnVectorMR = temp_aic(bestidx);

save e3_popnVectorMR_params_groupfit bestparams_popnVectorMR r2_popnVectorMR  aic_popnVectorMR

for i=1:2
    
    sims(i,:) = popnVectorMR(bestparams_popnVectorMR,groupavg_hand_data(i,11:210),clamp_angle,group(i),rwd(i,:));
...
simulations = popnVectorMR(params, hand_data, rot, group,rwd);
